...
public class ResultService {
    ...
    public static void saveResult(double n1, double n2, double sum, double product, double subtract, Double quotient) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            // Insert the result
            String insert = "INSERT INTO calc_results (number1, number2, sum_result, product_result, subtract_result, quotient_result) VALUES (?, ?, ?, ?, ?, ?)";
